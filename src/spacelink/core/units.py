...
For quantities with physical dimensions in decibels, use the ``u.dB(unit)`` unit. For
example, ``3.01 * u.dB(u.W)``. Or use one of the aliases defined in this module for
common cases like ``u.dBW`` or ``u.dBm``.
