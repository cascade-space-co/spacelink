...
from spacelink.units import Watts, Temperature, Decibels
...
class Signal:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.power == other.power and 
                self.noise_temperature == other.noise_temperature and
                self.axial_ratio == other.axial_ratio)

    def __repr__(self) -> str:
        """Return a string representation of the signal."""
        return f"Signal(power={self.power}, noise_temperature={self.noise_temperature}, axial_ratio={self.axial_ratio})"
