...
def test_invalid_parameters():
    ...
    # Invalid implementation loss (should be negative)
    with pytest.raises(ValueError, match="Implementation loss must be negative"):
        Mode(
            name="Test",
            coding_scheme="LDPC",
            modulation="QPSK",
            ...
            spectral_efficiency=1.0,
            required_ebno=3.0,
            implementation_loss=2.0,  # Positive loss is invalid
        )
